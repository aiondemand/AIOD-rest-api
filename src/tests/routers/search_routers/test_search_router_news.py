...
def test_search_happy_path(client: TestClient):
    ...
    assert resource['name'] == "Name of the News item"
    assert resource['headline'] == "A headline to show on top of the page."
    assert resource['alternative_headline'] == "An alternative headline."
