...
__named_relations = sorted(
    non_abstract_subclasses(NamedRelation), key=lambda n: n.__tablename__
)
__filtered_relations = (
    n for n in __named_relations if n.__tablename__ not in __exclusion_list
)
