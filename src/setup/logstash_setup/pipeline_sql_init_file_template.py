PIPELINE_SQL_INIT_FILE_TEMPLATE = """SELECT {{entity_name}}.identifier, {{entity_name}}.name, text.plain as 'plain', text.html as 'html', aiod_entry.date_modified {{extra_fields}}
