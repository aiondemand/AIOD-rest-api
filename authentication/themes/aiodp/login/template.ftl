...
<head>
    ...
    <link rel="icon" href="${url.resourcesPath}/img/aiod-favicon.png" />
...
<div class="${properties.kcLoginClass!}">
    <div id="kc-header" class="${properties.kcHeaderClass!}">
        <div id="kc-header-wrapper"
             ...
             <a href="${properties.aiodLogoUrl!url.baseUrl}">
             <img src="${url.resourcesPath}/img/aiod-logo.svg"
             alt="${msg('loginAccountTitle')}"></a></div>
    </div>
