...
curl -u elastic:${ES_PASSWORD} -X PUT elasticsearch:9200/event?pretty -H 'Content-Type: application/json' -d @/event.json
...
curl -u elastic:${ES_PASSWORD} -X PUT elasticsearch:9200/news?pretty -H 'Content-Type: application/json' -d @/news.json
curl -u elastic:${ES_PASSWORD} -X PUT elasticsearch:9200/organisation?pretty -H 'Content-Type: application/json' -d @/organisation.json
curl -u elastic:${ES_PASSWORD} -X PUT elasticsearch:9200/project?pretty -H 'Content-Type: application/json' -d @/project.json
